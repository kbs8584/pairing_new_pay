...
public class SmartroVact implements Van {
	private static Logger logger = LoggerFactory.getLogger(com.pgmate.pay.van.SmartroVact.class);
	...
	public SmartroVact(SharedMap<String, Object> tmnVanMap) {
		VAN_ID =  tmnVanMap.getString("vanId").trim();
		CRYPTOKEY	= StringEscapeUtils.escapeHtml(tmnVanMap.getString("cryptoKey").trim());
	...
	public synchronized static void main(String[] args) {
		...
		SmartroVact sm = new SmartroVact(tmnVanMap);
