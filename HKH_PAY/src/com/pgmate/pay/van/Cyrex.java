 ...
 *
 */
public class Cyrex implements Van {

	private static Logger logger 	= LoggerFactory.getLogger( com.pgmate.pay.van.Cyrex.class ); 
	public static final String CONTENTS_JSON	= "application/json";
	public static final String METHOD_POST		= "POST";
	public static final String METHOD_GET		= "GET";
	public String C3_URL			= "https://api.pairingsolution.com/api/%s";
	public String van 		= "";
	public String vanId		= "";
	public String payKey	= "";
	
	
	public Cyrex(SharedMap<String, Object> tmnVanMap) {
	...
	public SharedMap<String, Object> sales(TrxDAO trxDAO, SharedMap<String, Object> sharedMap,Response response) {
		...
		pay.tmnId		= vanId;								//필수값아님. 터미널아이디 : CYREXPAY 에서 지정한 터미널 아이디
		...
		logger.info("cyrex result : {},{},{}",res.result.resultCd,res.result.resultMsg,res.result.advanceMsg);
